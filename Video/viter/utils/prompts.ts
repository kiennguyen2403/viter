...
\n\n
Please return only the JSON, I don't want any extra text including the word JSON. Please divide the recommendations into single sentences that are easy to read.
`;
...
export const finalReviewOutput = `
Please organise it in the the following JSON format in the following sequence: \n\n 
{
  "grade": {
    "overall": number (0-10);
    "contentGrade": number (0-10);
    "paletteGrade": number (0-10);
    "fontGrade": number (0-10);
    "syntaxAndCorrectness": string;
  },
  "feedbacks": string[],
  "recommendations": string[],
...
\n\n
Please return only the JSON, I don't want any extra text including the word JSON. Please divide the recommendations and feedbacks into single sentences that are easy to read.
`;
...
export const inputWording = (wordingInJson: string) => {
  return `This is the content of a 1-page poster at the moment ${wordingInJson}, give me recommendation based on the instruction`;
}

export const finalReviewInformation = (tags:string[]) => `
   This is the some of the information provided by the faulty's detection system: ${tags.join(", ")}
`;
